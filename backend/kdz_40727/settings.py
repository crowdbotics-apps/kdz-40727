"""
Django settings for kdz_40727 project.
...
WSGI_APPLICATION = 'kdz_40727.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kdz_40727 API",
    "DESCRIPTION": "API documentation for kdz_40727 App",
    "VERSION": "v1",
}
